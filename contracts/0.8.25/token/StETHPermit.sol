...
abstract contract StETHPermit is IERC2612, StETH {
    ...
    function _initializeEIP712StETH(address _eip712StETH) internal {
        ...
        StorageSlot.getAddressSlot(EIP712_STETH_POSITION).value = _eip712StETH;
    ...
    function getEIP712StETH() public view returns (address) {
        return StorageSlot.getAddressSlot(EIP712_STETH_POSITION).value;
    }
}
