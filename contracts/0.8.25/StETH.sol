...
abstract contract StETH is IERC20, Pausable {
    ...
    */
    ...
    function getSharesByPooledEth(uint256 _ethAmount) public view returns (uint256) {
        return Math.mulDiv(_ethAmount, _getTotalShares(), _getTotalPooledEther());
    }
    ...
    function getPooledEthByShares(uint256 _sharesAmount) public view returns (uint256) {
        return Math.mulDiv(_sharesAmount, _getTotalPooledEther(), _getTotalShares());
    }
    ...
    function _isMinter(address) internal view virtual returns (bool) {
        return false;
    }

    function _isBurner(address) internal view virtual returns (bool) {
        return false;
    }
    ...
    function _getTotalShares() internal view returns (uint256) {
        return StorageSlot.getUint256Slot(TOTAL_SHARES_POSITION).value;
    }
    ...
    function _mintShares(address _recipient, uint256 _sharesAmount) internal returns (uint256 newTotalShares) {
        ...
        StorageSlot.getUint256Slot(TOTAL_SHARES_POSITION).value = newTotalShares;
