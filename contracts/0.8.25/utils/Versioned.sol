...
contract Versioned {
    ...
    constructor() {
        ...
        _setContractVersion(PETRIFIED_VERSION_MARK);
    }

    /// @notice Returns the current contract version.
    function getContractVersion() public view returns (uint256) {
        return StorageSlot.getUint256Slot(CONTRACT_VERSION_POSITION).value;
    }
    ...
    function _setContractVersion(uint256 version) private {
        StorageSlot.getUint256Slot(CONTRACT_VERSION_POSITION).value = version;
