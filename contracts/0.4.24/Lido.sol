...
contract Lido is Versioned, StETHPermit, AragonApp {
    ...
    /// @dev number of deposited validators tracked for legacy compatibility
     ...
     * @notice `_depositedValidators` is DEPRECATED, it is used only for backward compatibility
     *
     * @param _amount amount of ETH to withdraw
     * @param _depositedValidators amount of deposited validators. In case of top up this value will be equal to 0
     */
    ...
    function _getDepositedValidators() internal view returns (uint256) {
        return DEPOSITED_VALIDATORS_POSITION.getLowUint128();
    }

    function _setDepositedValidators(uint256 _newDepositedValidators) internal {
        DEPOSITED_VALIDATORS_POSITION.setLowUint128(_newDepositedValidators);
    }
