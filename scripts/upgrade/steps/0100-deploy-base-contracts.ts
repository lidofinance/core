  ...
  const constructorArgs: {
    ...
    ValidatorExitDelayVerifier: [
      locatorAddress,
      {
        ...
        gIFirstHistoricalSummaryPreGloas: parameters.validatorExitDelayVerifier.gIFirstHistoricalSummaryPreGloas,
        gIFirstHistoricalSummary: parameters.validatorExitDelayVerifier.gIFirstHistoricalSummary,
