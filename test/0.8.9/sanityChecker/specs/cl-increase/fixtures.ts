...
import { ClIncreaseCase, report } from "./lib";

export const clIncreaseCases: ClIncreaseCase[] = [
  {
    title: "accepts first-report deposits when they remain pending",
    rationale: "Deposits fund pending balance directly; they are not capped by the annual validators growth allowance.",
    report: report({
