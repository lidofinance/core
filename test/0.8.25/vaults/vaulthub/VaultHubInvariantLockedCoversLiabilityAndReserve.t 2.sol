...
contract VaultHubLockedInvariantTest is Test {
    ...
    function invariant_lockedCoversLiabilityAndReserve() public {
        ...
        assertGe(
            lhs, 
            rhs, 
            "INVARIANT VIOLATED: locked amount does not cover liability and reserve"
        );
    }
    ...
    function afterInvariant() external view {
        ...
        console.log("Set liability target: %d / %d / %d", liabilitySuccess, liabilityFail, liabilitySuccess + liabilityFail);
