...
contract VaultHubShortfallFuzzTest is Test {
    ...
    function testFuzz_shortfallOnInitialUnhealthyState(uint96 extraFunding) public {
        ...
        assertTrue(isHealthyAfter, "SHORTFALL FAILED: Rebalancing by shortfall did not make vault healthy!");
    }
     ...
     * forge-config: default.fuzz.runs = 1000000
     */
    function testFuzz_shortfallWithShareRateVariation(uint16 newShareRateBP, uint96 extraFunding) public {
