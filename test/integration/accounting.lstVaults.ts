...
describe("Accounting with LstVaults integration", () => {
  ...
  it("Should account correctly with no LstVaults rebase", async () => {
  ...
  it.skip("Should account correctly with negative LstVaults rebase", async () => {
    const { lido, accountingOracle } = ctx.contracts;
  ...
  it.skip("Should account correctly with positive LstVaults rewards", async () => {
  ...
  it.skip("Should account correctly with positive LstVaults rebase at limits", async () => {
  ...
  it.skip("Should account correctly with positive LstVaults rebase above limits", async () => {
    const { lido, accountingOracle, oracleReportSanityChecker, stakingRouter } = ctx.contracts;
  ...
  it.skip("Should account correctly with no LstVaults withdrawals", async () => {
    const { lido, accountingOracle } = ctx.contracts;
  ...
  it.skip("Should account correctly with LstVaults withdrawals at limits", async () => {
  ...
  it.skip("Should account correctly with LstVaults withdrawals above limits", async () => {
    const { lido, accountingOracle, withdrawalVault, stakingRouter } = ctx.contracts;
  ...
  it.skip("Should account correctly LstVaults shares burn at limits", async () => {
  ...
  it.skip("Should account correctly LstVaults shares burn above limits", async () => {
    const { lido, burner, wstETH } = ctx.contracts;
  ...
  it.skip("Should account correctly overfill LstVaults", async () => {
