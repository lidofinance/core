...
abstract contract Confirmations {
    ...
    function __Confirmations_init() internal {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01130000, 1037618708755) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01130001, 0) }
     ...
     */
    function getConfirmExpiry() public view returns (uint256) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01110000, 1037618708753) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01110001, 0) }
     ...
     *
     */
    function _collectAndCheckConfirmations(bytes calldata _calldata, bytes32[] memory _roles) internal returns (bool) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01140000, 1037618708756) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01140001, 3) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01143000, _calldata.offset) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01142000, _calldata.length) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01141001, _roles) }
        if (_roles.length == 0) revert ZeroConfirmingRoles();

        uint256 numberOfRoles = _roles.length;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000004,numberOfRoles)}
        uint256 numberOfConfirms = 0;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000005,numberOfConfirms)}
        bool[] memory deferredConfirms = new bool[](numberOfRoles);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010006,0)}
        bool isRoleMember = false;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000007,isRoleMember)}

        ConfirmationStorage storage $ = _getConfirmationsStorage();assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010008,0)}
        uint256 expiryTimestamp = block.timestamp + $.confirmExpiry;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000009,expiryTimestamp)}

        for (uint256 i = 0; i < numberOfRoles; ++i) {
            bytes32 role = _roles[i];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000000d,role)}
        ...
        if (numberOfConfirms == numberOfRoles) {
            for (uint256 i = 0; i < numberOfRoles; ++i) {
                bytes32 role = _roles[i];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000000e,role)}
     ...
     */
    function _setConfirmExpiry(uint256 _newConfirmExpiry) internal {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01160000, 1037618708758) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01160001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01161000, _newConfirmExpiry) }
        _validateConfirmExpiry(_newConfirmExpiry);

        ConfirmationStorage storage $ = _getConfirmationsStorage();assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0001000a,0)}

        uint256 oldConfirmExpiry = $.confirmExpiry;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000000b,oldConfirmExpiry)}
        $.confirmExpiry = _newConfirmExpiry;uint256 certora_local12 = $.confirmExpiry;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000000c,certora_local12)}

        emit ConfirmExpirySet(msg.sender, oldConfirmExpiry, _newConfirmExpiry);
    }

    function _validateConfirmExpiry(uint256 _newConfirmExpiry) internal pure {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01150000, 1037618708757) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01150001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01151000, _newConfirmExpiry) }
        if (_newConfirmExpiry < MIN_CONFIRM_EXPIRY || _newConfirmExpiry > MAX_CONFIRM_EXPIRY)
            revert ConfirmExpiryOutOfBounds();
    }

    function _getConfirmationsStorage() private pure returns (ConfirmationStorage storage $) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01170000, 1037618708759) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01170001, 0) }
        assembly {
