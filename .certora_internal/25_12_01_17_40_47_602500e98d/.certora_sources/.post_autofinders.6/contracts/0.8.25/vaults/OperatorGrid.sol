...
contract OperatorGrid is AccessControlEnumerableUpgradeable, Confirmable2Addresses {
    ...
    function initialize(address _admin, TierParams calldata _defaultTierParams) external initializer {
        ...
        ERC7201Storage storage $ = _getStorage();assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010044,0)}
    ...
    function registerGroup(address _nodeOperator, uint256 _shareLimit) external onlyRole(REGISTRY_ROLE) {
        ...
        ERC7201Storage storage $ = _getStorage();assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010045,0)}
        ...
        });assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00020077,0)}
    ...
    function updateGroupShareLimit(address _nodeOperator, uint256 _shareLimit) external onlyRole(REGISTRY_ROLE) {
        ...
        ERC7201Storage storage $ = _getStorage();assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010046,0)}
        Group storage group_ = $.groups[_nodeOperator];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010047,0)}
        if (group_.operator == address(0)) revert GroupNotExists();

        group_.shareLimit = SafeCast.toUint96(_shareLimit);uint96 certora_local120 = group_.shareLimit;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000078,certora_local120)}
    ...
    function nodeOperatorAddress(uint256 _index) external view returns (address) {
        ERC7201Storage storage $ = _getStorage();assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010048,0)}
    ...
    function registerTiers(
        ...
        ERC7201Storage storage $ = _getStorage();assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010049,0)}
        Group storage group_ = $.groups[_nodeOperator];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0001004a,0)}
        if (group_.operator == address(0)) revert GroupNotExists();

        uint256 tierId = $.tiers.length;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000004b,tierId)}
        uint256 length = _tiers.length;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000004c,length)}
        for (uint256 i = 0; i < length; i++) {
            ...
            Tier memory tier_ = Tier({
                ...
                liabilityShares: 0
            });assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0001008c,0)}
            $.tiers.push(tier_);
    ...
    function tier(uint256 _tierId) external view returns (Tier memory) {
        ERC7201Storage storage $ = _getStorage();assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0001004d,0)}
    ...
    function alterTiers(
        ...
        ERC7201Storage storage $ = _getStorage();assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0001004e,0)}
        uint256 length = _tierIds.length;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000004f,length)}
        uint256 tiersLength = $.tiers.length;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000050,tiersLength)}
        ...
        for (uint256 i = 0; i < length; i++) {
            ...
            Tier storage tier_ = $.tiers[_tierIds[i]];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0001008d,0)}

            tier_.shareLimit = SafeCast.toUint96(_tierParams[i].shareLimit);uint96 certora_local142 = tier_.shareLimit;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000008e,certora_local142)}
            tier_.reserveRatioBP = uint16(_tierParams[i].reserveRatioBP);uint16 certora_local143 = tier_.reserveRatioBP;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000008f,certora_local143)}
            tier_.forcedRebalanceThresholdBP = uint16(_tierParams[i].forcedRebalanceThresholdBP);uint16 certora_local144 = tier_.forcedRebalanceThresholdBP;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000090,certora_local144)}
            tier_.infraFeeBP = uint16(_tierParams[i].infraFeeBP);uint16 certora_local145 = tier_.infraFeeBP;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000091,certora_local145)}
            tier_.liquidityFeeBP = uint16(_tierParams[i].liquidityFeeBP);uint16 certora_local146 = tier_.liquidityFeeBP;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000092,certora_local146)}
            tier_.reservationFeeBP = uint16(_tierParams[i].reservationFeeBP);uint16 certora_local147 = tier_.reservationFeeBP;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000093,certora_local147)}
    ...
    */
    ...
    function changeTier(
        ...
        ERC7201Storage storage $ = _getStorage();assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010051,0)}
        ...
        VaultHub vaultHub = _vaultHub();assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010052,0)}

        uint256 vaultTierId = $.vaultTier[_vault];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000053,vaultTierId)}
        if (vaultTierId == _requestedTierId) revert TierAlreadySet();

        address nodeOperator = IStakingVault(_vault).nodeOperator();assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000054,nodeOperator)}
        ...
        Tier storage requestedTier = $.tiers[_requestedTierId];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010055,0)}
        ...
        uint256 vaultLiabilityShares = vaultHub.liabilityShares(_vault);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000056,vaultLiabilityShares)}

        if (_requestedShareLimit < vaultLiabilityShares) {
            revert RequestedShareLimitTooLow(_requestedShareLimit, vaultLiabilityShares);
        }

        address vaultOwner = vaultHub.vaultConnection(_vault).owner;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000057,vaultOwner)}
        ...
        Tier storage currentTier = $.tiers[vaultTierId];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010058,0)}

        currentTier.liabilityShares -= uint96(vaultLiabilityShares);uint96 certora_local121 = currentTier.liabilityShares;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000079,certora_local121)}
        requestedTier.liabilityShares += uint96(vaultLiabilityShares);uint96 certora_local122 = requestedTier.liabilityShares;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000007a,certora_local122)}

        $.vaultTier[_vault] = _requestedTierId;uint256 certora_local123 = $.vaultTier[_vault];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000007b,certora_local123)}
    ...
    function syncTier(address _vault) external returns (bool) {
        ...
        address vaultOwner, address nodeOperator, uint256 vaultTierId) = _getVaultContextForConnectedVault(_vault);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010059,0)}

        Tier storage tier_ = _getStorage().tiers[vaultTierId];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0001005a,0)}
    ...
    function updateVaultShareLimit(address _vault, uint256 _requestedShareLimit) external returns (bool) {
        (VaultHub vaultHub, VaultHub.VaultConnection memory vaultConnection,
        address vaultOwner, address nodeOperator, uint256 vaultTierId) = _getVaultContextForConnectedVault(_vault);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0001005b,0)}

        uint256 tierShareLimit = _getStorage().tiers[vaultTierId].shareLimit;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000005c,tierShareLimit)}
        ...
        uint256 vaultLiabilityShares = vaultHub.liabilityShares(_vault);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000005d,vaultLiabilityShares)}
    ...
    function updateVaultFees(
        ...
        VaultHub vaultHub = _vaultHub();assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0001005f,0)}
        if (!vaultHub.isVaultConnected(_vault)) revert VaultNotConnected();

        VaultHub.VaultConnection memory vaultConnection = vaultHub.vaultConnection(_vault);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010060,0)}
        vaultHub.updateConnection(
            _vault,
            vaultConnection.shareLimit,
            vaultConnection.reserveRatioBP,
   ...
   // -----------------------------
    ...
    function onMintedShares(
        ...
        ERC7201Storage storage $ = _getStorage();assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010061,0)}

        if (!_overrideLimits && $.isVaultInJail[_vault]) revert VaultInJail();

        uint256 tierId = $.vaultTier[_vault];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000062,tierId)}
        Tier storage tier_ = $.tiers[tierId];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010063,0)}

        uint96 tierLiabilityShares = tier_.liabilityShares;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000064,tierLiabilityShares)}
        if (!_overrideLimits && tierLiabilityShares + _amount > tier_.shareLimit) {
            revert TierLimitExceeded();
        }

        tier_.liabilityShares = tierLiabilityShares + uint96(_amount);uint96 certora_local124 = tier_.liabilityShares;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000007c,certora_local124)}
    ...
    function onBurnedShares(
        ...
        ERC7201Storage storage $ = _getStorage();assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010065,0)}

        uint256 tierId = $.vaultTier[_vault];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000066,tierId)}

        Tier storage tier_ = $.tiers[tierId];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010067,0)}

        // we skip the check for minted shared underflow, because it's done in the VaultHub.burnShares()

        tier_.liabilityShares -= uint96(_amount);uint96 certora_local125 = tier_.liabilityShares;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000007d,certora_local125)}
    ...
    function setVaultJailStatus(address _vault, bool _isInJail) external onlyRole(REGISTRY_ROLE) {
        ...
        ERC7201Storage storage $ = _getStorage();assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010068,0)}
        if ($.isVaultInJail[_vault] == _isInJail) revert VaultInJailAlreadySet();
        $.isVaultInJail[_vault] = _isInJail;bool certora_local126 = $.isVaultInJail[_vault];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000007e,certora_local126)}
    ...
    {
        ERC7201Storage storage $ = _getStorage();assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010069,0)}

        tierId = $.vaultTier[_vault];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000007f,tierId)}

        Tier memory t = $.tiers[tierId];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0001006a,0)}
        nodeOperator = t.operator;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000080,nodeOperator)}

        shareLimit = t.shareLimit;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000081,shareLimit)}
        reserveRatioBP = t.reserveRatioBP;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000082,reserveRatioBP)}
        forcedRebalanceThresholdBP = t.forcedRebalanceThresholdBP;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000083,forcedRebalanceThresholdBP)}
        infraFeeBP = t.infraFeeBP;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000084,infraFeeBP)}
        liquidityFeeBP = t.liquidityFeeBP;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000085,liquidityFeeBP)}
        reservationFeeBP = t.reservationFeeBP;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000086,reservationFeeBP)}
    }
    ...
    function effectiveShareLimit(address _vault) public view returns (uint256) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01360000, 1037618708790) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01360001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01361000, _vault) }
        VaultHub vaultHub = _vaultHub();assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0001006b,0)}
        uint256 shareLimit = vaultHub.vaultConnection(_vault).shareLimit;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000006c,shareLimit)}
        uint256 liabilityShares = vaultHub.liabilityShares(_vault);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000006d,liabilityShares)}

        uint256 gridShareLimit = _gridRemainingShareLimit(_vault) + liabilityShares;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000006e,gridShareLimit)}
    ...
    function _gridRemainingShareLimit(address _vault) internal view returns (uint256) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01300000, 1037618708784) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01300001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01301000, _vault) }
        ERC7201Storage storage $ = _getStorage();assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0001006f,0)}
        uint256 tierId = $.vaultTier[_vault];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000070,tierId)}
        Tier storage t = $.tiers[tierId];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010071,0)}

        uint256 tierLimit = t.shareLimit;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000072,tierLimit)}
        uint256 tierRemaining = tierLimit > t.liabilityShares ? tierLimit - t.liabilityShares : 0;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000073,tierRemaining)}

        if (tierId == DEFAULT_TIER_ID) return tierRemaining;

        Group storage g = $.groups[t.operator];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010074,0)}
        uint256 groupLimit = g.shareLimit;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000075,groupLimit)}
        uint256 groupRemaining = groupLimit > g.liabilityShares ? groupLimit - g.liabilityShares : 0;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000076,groupRemaining)}
    ...
    function _validateParams(
      ...
      uint256 _liquidityFeeBP,
      uint256 _reservationFeeBP
    ) internal pure {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01310000, 1037618708785) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01310001, 6) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01311000, _tierId) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01311001, _reserveRatioBP) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01311002, _forcedRebalanceThresholdBP) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01311003, _infraFeeBP) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01311004, _liquidityFeeBP) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01311005, _reservationFeeBP) }
    ...
    function _vaultHub() internal view returns (VaultHub) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01330000, 1037618708787) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01330001, 0) }
        return VaultHub(payable(LIDO_LOCATOR.vaultHub()));
    }

    function _getStorage() private pure returns (ERC7201Storage storage $) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01340000, 1037618708788) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01340001, 0) }
        assembly {
    ...
    function _getVaultContextForConnectedVault(address _vault) internal view returns (
        ...
        address nodeOperator,
        uint256 vaultTierId
    ) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01320000, 1037618708786) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01320001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01321000, _vault) }
        if (_vault == address(0)) revert ZeroArgument("_vault");

        vaultHub = _vaultHub();assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00020087,0)}
        if (!vaultHub.isVaultConnected(_vault)) revert VaultNotConnected();

        vaultConnection = vaultHub.vaultConnection(_vault);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00020088,0)}
        vaultOwner = vaultConnection.owner;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000089,vaultOwner)}
        nodeOperator = IStakingVault(_vault).nodeOperator();assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000008a,nodeOperator)}

        vaultTierId = _getStorage().vaultTier[_vault];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000008b,vaultTierId)}
    }

    function _requireLessOrEqToBP(uint256 _valueBP, uint256 _maxValueBP) internal pure {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01350000, 1037618708789) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01350001, 2) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01351000, _valueBP) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff01351001, _maxValueBP) }
