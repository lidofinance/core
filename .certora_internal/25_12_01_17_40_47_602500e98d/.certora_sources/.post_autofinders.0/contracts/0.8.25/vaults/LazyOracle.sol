...
contract LazyOracle is ILazyOracle, AccessControlEnumerableUpgradeable {
    ...
    */
    ...
    function latestReportData() external view returns (
        ...
        Storage storage $ = _storage();assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010025,0)}
    ...
    function quarantineValue(address _vault) external view returns (uint256) {
        Quarantine memory q = _storage().vaultQuarantines[_vault];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010026,0)}
        uint256 pendingValue = q.pendingTotalValueIncrease;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000027,pendingValue)}
        if (pendingValue > 0) {
    ...
    function vaultQuarantine(address _vault) external view returns (QuarantineInfo memory) {
        Quarantine memory q = _storage().vaultQuarantines[_vault];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010028,0)}

        bool isQuarantineInactive = q.pendingTotalValueIncrease == 0;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000029,isQuarantineInactive)}
    ...
    function batchVaultsInfo(uint256 _offset, uint256 _limit) external view returns (VaultInfo[] memory) {
        VaultHub vaultHub = _vaultHub();assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0001002a,0)}
        uint256 vaultCount = vaultHub.vaultsCount();assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000002b,vaultCount)}
        uint256 batchSize;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000002c,batchSize)}
        if (_offset > vaultCount) {
            batchSize = 0;
        } else {
            batchSize = _offset + _limit > vaultCount ? vaultCount - _offset : _limit;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000053,batchSize)}
        }

        VaultInfo[] memory batch = new VaultInfo[](batchSize);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0001002d,0)}
        for (uint256 i = 0; i < batchSize; i++) {
            address vaultAddress = vaultHub.vaultByIndex(_offset + i + 1);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000052,vaultAddress)}
            batch[i] = _vaultInfo(vaultAddress, vaultHub);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00020054,0)}
        }
        return batch;
    }
    ...
    function batchValidatorStatuses(
        ...
        batch = new IPredepositGuarantee.ValidatorStatus[](_pubkeys.length);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00020045,0)}

        for (uint256 i = 0; i < _pubkeys.length; i++) {
            batch[i] = predepositGuarantee().validatorStatus(_pubkeys[i]);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00020055,0)}
        }
    }
    ...
    function updateReportData(
        ...
        Storage storage $ = _storage();assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0001002e,0)}
        $.vaultsDataTimestamp = uint64(_vaultsDataTimestamp);uint64 certora_local70 = $.vaultsDataTimestamp;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000046,certora_local70)}
        $.vaultsDataRefSlot = uint48(_vaultsDataRefSlot);uint48 certora_local71 = $.vaultsDataRefSlot;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000047,certora_local71)}
        $.vaultsDataTreeRoot = _vaultsDataTreeRoot;bytes32 certora_local72 = $.vaultsDataTreeRoot;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000048,certora_local72)}
        $.vaultsDataReportCid = _vaultsDataReportCid;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00020049,0)}
    ...
    function updateVaultData(
        ...
        );assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000002f,leaf)}
        if (!MerkleProof.verify(_proof, _storage().vaultsDataTreeRoot, leaf)) revert InvalidProof();

        uint256 vaultsDataTimestamp = _storage().vaultsDataTimestamp;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000030,vaultsDataTimestamp)}
    ...
    function removeVaultQuarantine(address _vault) external {
        ...
        mapping(address => Quarantine) storage quarantines = _storage().vaultQuarantines;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010032,0)}
    ...
    function _vaultInfo(address _vault, VaultHub _vh) internal view returns (VaultInfo memory) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00160000, 1037618708502) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00160001, 2) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00161000, _vault) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00161001, _vh) }
        IStakingVault vault = IStakingVault(_vault);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010033,0)}
        VaultHub.VaultConnection memory connection = _vh.vaultConnection(_vault);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010034,0)}
        VaultHub.VaultRecord memory record = _vh.vaultRecord(_vault);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010035,0)}
        return VaultInfo(
            _vault,
    ...
    function _handleSanityChecks(
        ...
        uint256 _liabilityShares,
        uint256 _maxLiabilityShares
    ) internal returns (uint256 totalValueWithoutQuarantine, int256 inOutDeltaOnRefSlot) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00170000, 1037618708503) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00170001, 7) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00171000, _vault) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00171001, _totalValue) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00171002, _reportRefSlot) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00171003, _reportTimestamp) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00171004, _cumulativeLidoFees) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00171005, _liabilityShares) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00171006, _maxLiabilityShares) }
        VaultHub vaultHub = _vaultHub();assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010036,0)}
        VaultHub.VaultRecord memory record = vaultHub.vaultRecord(_vault);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010037,0)}
        uint48 previousReportTs = record.report.timestamp;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000038,previousReportTs)}
        ...
        int256 currentInOutDelta = record.inOutDelta.currentValue();assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000039,currentInOutDelta)}
        inOutDeltaOnRefSlot = record.inOutDelta.getValueForRefSlot(uint48(_reportRefSlot));assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000004a,inOutDeltaOnRefSlot)}

        // 2. Sanity check for total value increase
        totalValueWithoutQuarantine = _processTotalValue(
            _vault, _totalValue, inOutDeltaOnRefSlot, record, _reportTimestamp);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000004b,totalValueWithoutQuarantine)}
        ...
        uint256 previousCumulativeLidoFees = record.cumulativeLidoFees;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000003a,previousCumulativeLidoFees)}
        ...
        uint256 maxLidoFees = (_reportTimestamp - previousReportTs) * uint256(_storage().maxLidoFeeRatePerSecond);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000003b,maxLidoFees)}
    ...
    */
    function _processTotalValue(
        ...
        uint256 _reportTimestamp
    ) internal returns (uint256 totalValueWithoutQuarantine) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00190000, 1037618708505) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00190001, 5) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00191000, _vault) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00191001, _reportedTotalValue) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00191002, _inOutDeltaOnRefSlot) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00191003, record) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00191004, _reportTimestamp) }
        ...
        Storage storage $ = _storage();assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0001003c,0)}
        Quarantine storage quarantine = $.vaultQuarantines[_vault];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0001003d,0)}
        uint256 quarantinedValue = quarantine.pendingTotalValueIncrease;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000003e,quarantinedValue)}
        ...
        uint256 onchainTotalValueOnRefSlot =
            uint256(int256(uint256(record.report.totalValue)) + _inOutDeltaOnRefSlot - record.report.inOutDelta);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000003f,onchainTotalValueOnRefSlot)}
        ...
        uint256 quarantineThreshold =
            onchainTotalValueOnRefSlot * (TOTAL_BASIS_POINTS + $.maxRewardRatioBP) / TOTAL_BASIS_POINTS;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000040,quarantineThreshold)}
        // 3. Determine current quarantine state
        QuarantineState currentState = _determineQuarantineState(quarantine, quarantinedValue, _reportTimestamp);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010041,0)}
        ...
        if (currentState == QuarantineState.NO_QUARANTINE) {
            ...
            if (_reportedTotalValue <= quarantineThreshold) {
                ...
                uint256 reminder = _reportedTotalValue > (onchainTotalValueOnRefSlot + quarantinedValue)
                    ...
                    : 0;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000058,reminder)}
                quarantine.totalValueRemainder = uint128(reminder);uint128 certora_local89 = quarantine.totalValueRemainder;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000059,certora_local89)}
            ...
            uint256 totalValueIncrease = _reportedTotalValue > onchainTotalValueOnRefSlot
                ...
                : 0;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000056,totalValueIncrease)}
            uint256 quarantineThresholdWithRewards = quarantineThreshold + quarantinedValue
                * (TOTAL_BASIS_POINTS + $.maxRewardRatioBP) / TOTAL_BASIS_POINTS;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000057,quarantineThresholdWithRewards)}
    ...
    function _determineQuarantineState(
        ...
        uint256 _vaultsDataTimestamp
    ) internal view returns (QuarantineState) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff001a0000, 1037618708506) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff001a0001, 3) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff001a1000, _quarantine.slot) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff001a1001, _quarantinedValue) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff001a1002, _vaultsDataTimestamp) }
        if (_quarantinedValue == 0) {
            return QuarantineState.NO_QUARANTINE;
        }

        bool isQuarantineExpired = (_vaultsDataTimestamp - _quarantine.startTimestamp) >= _storage().quarantinePeriod;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000042,isQuarantineExpired)}
    ...
    ) internal {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00180000, 1037618708504) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00180001, 3) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00181000, _quarantine.slot) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00181001, _amountToQuarantine) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00181002, _currentTimestamp) }
        _quarantine.pendingTotalValueIncrease = uint128(_amountToQuarantine);uint128 certora_local76 = _quarantine.pendingTotalValueIncrease;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000004c,certora_local76)}
        _quarantine.startTimestamp = uint64(_currentTimestamp);uint64 certora_local77 = _quarantine.startTimestamp;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000004d,certora_local77)}
        _quarantine.totalValueRemainder = 0;uint128 certora_local78 = _quarantine.totalValueRemainder;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000004e,certora_local78)}
    }
    ...
    function _updateSanityParams(
        ...
        uint256 _maxRewardRatioBP,
        uint256 _maxLidoFeeRatePerSecond
    ) internal {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff001b0000, 1037618708507) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff001b0001, 3) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff001b1000, _quarantinePeriod) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff001b1001, _maxRewardRatioBP) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff001b1002, _maxLidoFeeRatePerSecond) }
        ...
        Storage storage $ = _storage();assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010043,0)}
        $.quarantinePeriod = uint64(_quarantinePeriod);uint64 certora_local79 = $.quarantinePeriod;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000004f,certora_local79)}
        $.maxRewardRatioBP = uint16(_maxRewardRatioBP);uint16 certora_local80 = $.maxRewardRatioBP;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000050,certora_local80)}
        $.maxLidoFeeRatePerSecond = uint64(_maxLidoFeeRatePerSecond);uint64 certora_local81 = $.maxLidoFeeRatePerSecond;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000051,certora_local81)}

        emit SanityParamsUpdated(_quarantinePeriod, _maxRewardRatioBP, _maxLidoFeeRatePerSecond);
    }

    function _mintableStETH(address _vault, VaultHub _vh) internal view returns (uint256) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff001c0000, 1037618708508) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff001c0001, 2) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff001c1000, _vault) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff001c1001, _vh) }
        uint256 mintableShares = _vh.totalMintingCapacityShares(_vault, 0 /* zero eth delta */);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000044,mintableShares)}
        return _getPooledEthBySharesRoundUp(mintableShares);
    }

    function _storage() internal pure returns (Storage storage $) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff001d0000, 1037618708509) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff001d0001, 0) }
        assembly {
            $.slot := LAZY_ORACLE_STORAGE_LOCATION
        }
    }

    function predepositGuarantee() internal view returns (IPredepositGuarantee) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff001e0000, 1037618708510) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff001e0001, 0) }
        return IPredepositGuarantee(LIDO_LOCATOR.predepositGuarantee());
    }

    function _vaultHub() internal view returns (VaultHub) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff001f0000, 1037618708511) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff001f0001, 0) }
        return VaultHub(payable(LIDO_LOCATOR.vaultHub()));
    }

    function _operatorGrid() internal view returns (OperatorGrid) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00200000, 1037618708512) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00200001, 0) }
        return OperatorGrid(LIDO_LOCATOR.operatorGrid());
    }

    function _getPooledEthBySharesRoundUp(uint256 _shares) internal view returns (uint256) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00210000, 1037618708513) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00210001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff00211000, _shares) }
