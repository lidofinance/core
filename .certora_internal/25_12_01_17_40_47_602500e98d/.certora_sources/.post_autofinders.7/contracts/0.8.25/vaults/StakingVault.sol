...
contract StakingVault is IStakingVault, Ownable2StepUpgradeable {
     ...
     */
    function owner() public view override(IStakingVault, OwnableUpgradeable) returns (address) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff021c0000, 1037618709020) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff021c0001, 0) }
     ...
     * @dev Fixes solidity interface inference
     */
    function pendingOwner() public view override(IStakingVault, Ownable2StepUpgradeable) returns (address) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff021b0000, 1037618709019) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff021b0001, 0) }
     ...
     */
    function nodeOperator() public view returns (address) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02150000, 1037618709013) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02150001, 0) }
     ...
     */
    function depositor() public view returns (address) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02130000, 1037618709011) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02130001, 0) }
     ...
     */
    function withdrawalCredentials() public view returns (bytes32) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02160000, 1037618709014) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02160001, 0) }
     ...
     */
    function availableBalance() public view returns (uint256) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02180000, 1037618709016) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02180001, 0) }
    ...
    function withdraw(address _recipient, uint256 _ether) external onlyOwner {
        ...
        (bool success, ) = _recipient.call{value: _ether}("");assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010001,0)}
    ...
    function pauseBeaconChainDeposits() external onlyOwner {
        Storage storage $ = _storage();assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010002,0)}
        if ($.beaconChainDepositsPaused) revert BeaconChainDepositsAlreadyPaused();

        $.beaconChainDepositsPaused = true;bool certora_local15 = $.beaconChainDepositsPaused;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000000f,certora_local15)}
    ...
    function resumeBeaconChainDeposits() external onlyOwner {
        Storage storage $ = _storage();assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010003,0)}
        if (!$.beaconChainDepositsPaused) revert BeaconChainDepositsAlreadyResumed();

        $.beaconChainDepositsPaused = false;bool certora_local16 = $.beaconChainDepositsPaused;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000010,certora_local16)}
    ...
    function stage(uint256 _ether) external onlyDepositor whenDepositsNotPaused {
        if (_ether == 0) revert ZeroArgument("_ether");
        uint256 balance = availableBalance();uint256 certora_local4 = balance;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000004,certora_local4)}
     ...
     */
    function unstage(uint256 _ether) public logInternal537(_ether)onlyDepositor {
        if (_ether == 0) revert ZeroArgument("_ether");
        uint256 staged = _storage().stagedBalance;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000005,staged)}
        if (staged < _ether) revert InsufficientStaged(staged, _ether);

        _storage().stagedBalance = staged - _ether;
        emit EtherUnstaged(_ether);
    }modifier logInternal537(uint256 _ether) { assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02190000, 1037618709017) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02190001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02191000, _ether) } _; }
    ...
    function requestValidatorExit(bytes calldata _pubkeys) external onlyOwner {
        ...
        uint256 keysCount = _pubkeys.length / PUBLIC_KEY_LENGTH;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000006,keysCount)}
        for (uint256 i = 0; i < keysCount; i++) {
            bytes memory pubkey = _pubkeys[i * PUBLIC_KEY_LENGTH:(i + 1) * PUBLIC_KEY_LENGTH];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010011,0)}
    ...
    function triggerValidatorWithdrawals(
        ...
        uint256 feePerRequest = TriggerableWithdrawals.getWithdrawalRequestFee();assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000007,feePerRequest)}
        uint256 totalFee = (_pubkeys.length / PUBLIC_KEY_LENGTH) * feePerRequest;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000008,totalFee)}
        ...
        uint256 excess = msg.value - totalFee;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000009,excess)}
        if (excess > 0) {
    ...
    function ejectValidators(bytes calldata _pubkeys, address _refundRecipient) external payable {
        ...
        uint256 feePerRequest = TriggerableWithdrawals.getWithdrawalRequestFee();assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000000a,feePerRequest)}
        uint256 totalFee = (_pubkeys.length / PUBLIC_KEY_LENGTH) * feePerRequest;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000000b,totalFee)}
        if (msg.value < totalFee) revert InsufficientValidatorWithdrawalFee(msg.value, totalFee);

        TriggerableWithdrawals.addFullWithdrawalRequests(_pubkeys, feePerRequest);

        uint256 excess = msg.value - totalFee;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000000c,excess)}
        if (excess > 0) {
     ...
     */
    function acceptOwnership() public override(IStakingVault, Ownable2StepUpgradeable) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff021a0000, 1037618709018) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff021a0001, 0) }
     ...
     */
    function transferOwnership(address _newOwner) public override(IStakingVault, Ownable2StepUpgradeable) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02170000, 1037618709015) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02170001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02171000, _newOwner) }
     ...
     */
    function renounceOwnership() public view logInternal532()onlyOwner override(OwnableUpgradeable) {
        revert RenouncementNotAllowed();
    }modifier logInternal532() { assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02140000, 1037618709012) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02140001, 0) } _; }
     ...
     */
    function _storage() private pure returns (Storage storage $) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02100000, 1037618709008) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02100001, 0) }
        assembly {
            $.slot := ERC7201_SLOT
        }
    }

    function _depositToBeaconChain(Deposit calldata _deposit, bytes memory _withdrawalCredentials) internal {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02110000, 1037618709009) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02110001, 2) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02117000, _deposit)mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02111001, _withdrawalCredentials) }
        uint256 balance = availableBalance();uint256 certora_local13 = balance;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000000d,certora_local13)}
     ...
     * @param _depositor Address of the new depositor
     */
    function _setDepositor(address _depositor) internal {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02120000, 1037618709010) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02120001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02121000, _depositor) }
        if (_depositor == address(0)) revert ZeroArgument("_depositor");
        if (_depositor == _storage().depositor) revert NewDepositorSameAsPrevious();
        address previousDepositor = _storage().depositor;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000000e,previousDepositor)}
