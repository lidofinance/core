...
library BLS12_381 {
     ...
     *  */
    function hashToG2(bytes32 message) internal view returns (G2Point memory result) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff028e0000, 1037618709134) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff028e0001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff028e1000, message) }
    ...
    function verifyDepositMessage(
    ...
    ) internal view {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff028f0000, 1037618709135) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff028f0001, 8) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff028f3000, pubkey.offset) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff028f2000, pubkey.length) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff028f3001, signature.offset) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff028f2001, signature.length) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff028f1002, amount) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff028f7003, depositY)mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff028f1004, withdrawalCredentials) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff028f1005, depositDomain) }
        // Hash the deposit message and map it to G2 point on the curve
        G2Point memory msgG2 = hashToG2(depositMessageSigningRoot(pubkey, amount, withdrawalCredentials, depositDomain));assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010060,0)}

        // BLS Pairing check input
        // pubkeyG1 | msgG2 | NEGATED_G1_GENERATOR | signatureG2
        bytes32[24] memory input;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010061,0)}
        ...
        input[4] = msgG2.x_c0_a;bytes32 certora_local100 = input[4];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000064,certora_local100)}
        input[5] = msgG2.x_c0_b;bytes32 certora_local101 = input[5];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000065,certora_local101)}
        input[6] = msgG2.x_c1_a;bytes32 certora_local102 = input[6];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000066,certora_local102)}
        input[7] = msgG2.x_c1_b;bytes32 certora_local103 = input[7];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000067,certora_local103)}
        input[8] = msgG2.y_c0_a;bytes32 certora_local104 = input[8];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000068,certora_local104)}
        input[9] = msgG2.y_c0_b;bytes32 certora_local105 = input[9];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000069,certora_local105)}
        input[10] = msgG2.y_c1_a;bytes32 certora_local106 = input[10];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000006a,certora_local106)}
        input[11] = msgG2.y_c1_b;bytes32 certora_local107 = input[11];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000006b,certora_local107)}

        // Negate G1 generator
        input[12] = 0x0000000000000000000000000000000017f1d3a73197d7942695638c4fa9ac0f;bytes32 certora_local108 = input[12];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000006c,certora_local108)}
        input[13] = 0xc3688c4f9774b905a14e3a3f171bac586c55e83ff97a1aeffb3af00adb22c6bb;bytes32 certora_local109 = input[13];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000006d,certora_local109)}
        input[14] = 0x00000000000000000000000000000000114d1d6855d545a8aa7d76c8cf2e21f2;bytes32 certora_local110 = input[14];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000006e,certora_local110)}
        input[15] = 0x67816aef1db507c96655b9d5caac42364e6f38ba0ecb751bad54dcd6b939c2ca;bytes32 certora_local111 = input[15];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000006f,certora_local111)}
        ...
        bool isPaired;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000062,isPaired)}
        /// @solidity memory-safe-assembly
        assembly {
            if iszero(
                and(
    ...
    function sha256Pair(bytes32 left, bytes32 right) internal view returns (bytes32 result) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02910000, 1037618709137) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02910001, 2) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02911000, left) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02911001, right) }
        /// @solidity memory-safe-assembly
        assembly {
    ...
    function pubkeyRoot(bytes calldata pubkey) internal view returns (bytes32 _pubkeyRoot) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02920000, 1037618709138) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02920001, 2) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02923000, pubkey.offset) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02922000, pubkey.length) }
    ...
    function computeDepositDomain(bytes4 genesisForkVersion) internal view returns (bytes32 depositDomain) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02900000, 1037618709136) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02900001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02901000, genesisForkVersion) }
        bytes32 forkDataRoot = sha256Pair(genesisForkVersion, bytes32(0));assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000063,forkDataRoot)}
        depositDomain = DOMAIN_DEPOSIT_TYPE | (forkDataRoot >> 32);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000070,depositDomain)}
    }
    ...
    function depositMessageSigningRoot(
        ...
        bytes32 withdrawalCredentials,
        bytes32 depositDomain
    ) internal view returns (bytes32 root) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02930000, 1037618709139) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02930001, 5) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02933000, pubkey.offset) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02932000, pubkey.length) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02931001, amount) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02931002, withdrawalCredentials) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02931003, depositDomain) }
        root = sha256Pair(
            ...
            depositDomain
        );assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000071,root)}
    }
}
