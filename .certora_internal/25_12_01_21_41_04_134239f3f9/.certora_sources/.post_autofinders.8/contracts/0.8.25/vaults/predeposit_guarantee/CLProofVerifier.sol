...
abstract contract CLProofVerifier {
  ...
  verify slot   │               │                          │               │
    ...
    function _validatePubKeyWCProof(
    ...
    ) internal view {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02700000, 1037618709104) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02700001, 2) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02707000, _witness)mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02701001, _withdrawalCredentials) }
        ...
        bytes32 leaf = BLS12_381.sha256Pair(BLS12_381.pubkeyRoot(_witness.pubkey), _withdrawalCredentials);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000001,leaf)}
     ...
     */
    function _verifySlot(IPredepositGuarantee.ValidatorWitness calldata _witness) internal view {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02720000, 1037618709106) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02720001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02727000, _witness)}
        bytes32 parentSlotProposer = BLS12_381.sha256Pair(
            SSZ.toLittleEndian(_witness.slot),
            SSZ.toLittleEndian(_witness.proposerIndex)
        );assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000003,parentSlotProposer)}
     ...
     */
    function _getValidatorGI(uint256 _offset, uint64 _provenSlot) internal view returns (GIndex) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02730000, 1037618709107) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02730001, 2) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02731000, _offset) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02731001, _provenSlot) }
        GIndex gI = _provenSlot < PIVOT_SLOT ? GI_FIRST_VALIDATOR_PREV : GI_FIRST_VALIDATOR_CURR;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010004,0)}
     ...
     */
    function _getParentBlockRoot(uint64 _childBlockTimestamp) internal view returns (bytes32) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02710000, 1037618709105) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02710001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02711000, _childBlockTimestamp) }
        (bool success, bytes memory data) = BEACON_ROOTS.staticcall(abi.encode(_childBlockTimestamp));assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010005,0)}
