...
library PinnedBeaconUtils {
    ...
    function getPinnedImplementation() internal view returns (address) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff021d0000, 1037618709021) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff021d0001, 0) }
     ...
     */
    function ossify() internal {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff021e0000, 1037618709022) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff021e0001, 0) }
        if (getPinnedImplementation() != address(0)) revert AlreadyOssified();
        
        address currentImplementation = IBeacon(ERC1967Utils.getBeacon()).implementation();assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000012,currentImplementation)}
