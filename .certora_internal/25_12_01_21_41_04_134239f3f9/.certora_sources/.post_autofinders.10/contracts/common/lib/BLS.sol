...
library BLS12_381 {
     ...
     *  */
    function hashToG2(bytes32 message) internal view returns (G2Point memory result) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02df0000, 1037618709215) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02df0001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02df1000, message) }
    ...
    function verifyDepositMessage(
    ...
    ) internal view {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02e00000, 1037618709216) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02e00001, 8) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02e03000, pubkey.offset) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02e02000, pubkey.length) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02e03001, signature.offset) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02e02001, signature.length) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02e01002, amount) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02e07003, depositY)mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02e01004, withdrawalCredentials) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02e01005, depositDomain) }
        // Hash the deposit message and map it to G2 point on the curve
        G2Point memory msgG2 = hashToG2(depositMessageSigningRoot(pubkey, amount, withdrawalCredentials, depositDomain));assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010001,0)}

        // BLS Pairing check input
        // pubkeyG1 | msgG2 | NEGATED_G1_GENERATOR | signatureG2
        bytes32[24] memory input;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00010002,0)}
        ...
        input[4] = msgG2.x_c0_a;bytes32 certora_local5 = input[4];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000005,certora_local5)}
        input[5] = msgG2.x_c0_b;bytes32 certora_local6 = input[5];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000006,certora_local6)}
        input[6] = msgG2.x_c1_a;bytes32 certora_local7 = input[6];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000007,certora_local7)}
        input[7] = msgG2.x_c1_b;bytes32 certora_local8 = input[7];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000008,certora_local8)}
        input[8] = msgG2.y_c0_a;bytes32 certora_local9 = input[8];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000009,certora_local9)}
        input[9] = msgG2.y_c0_b;bytes32 certora_local10 = input[9];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000000a,certora_local10)}
        input[10] = msgG2.y_c1_a;bytes32 certora_local11 = input[10];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000000b,certora_local11)}
        input[11] = msgG2.y_c1_b;bytes32 certora_local12 = input[11];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000000c,certora_local12)}

        // Negate G1 generator
        input[12] = 0x0000000000000000000000000000000017f1d3a73197d7942695638c4fa9ac0f;bytes32 certora_local13 = input[12];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000000d,certora_local13)}
        input[13] = 0xc3688c4f9774b905a14e3a3f171bac586c55e83ff97a1aeffb3af00adb22c6bb;bytes32 certora_local14 = input[13];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000000e,certora_local14)}
        input[14] = 0x00000000000000000000000000000000114d1d6855d545a8aa7d76c8cf2e21f2;bytes32 certora_local15 = input[14];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff0000000f,certora_local15)}
        input[15] = 0x67816aef1db507c96655b9d5caac42364e6f38ba0ecb751bad54dcd6b939c2ca;bytes32 certora_local16 = input[15];assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000010,certora_local16)}
        ...
        bool isPaired;assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000003,isPaired)}
        /// @solidity memory-safe-assembly
        assembly {
            if iszero(
                and(
    ...
    function sha256Pair(bytes32 left, bytes32 right) internal view returns (bytes32 result) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02e20000, 1037618709218) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02e20001, 2) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02e21000, left) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02e21001, right) }
        /// @solidity memory-safe-assembly
        assembly {
    ...
    function pubkeyRoot(bytes calldata pubkey) internal view returns (bytes32 _pubkeyRoot) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02e30000, 1037618709219) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02e30001, 2) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02e33000, pubkey.offset) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02e32000, pubkey.length) }
    ...
    function computeDepositDomain(bytes4 genesisForkVersion) internal view returns (bytes32 depositDomain) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02e10000, 1037618709217) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02e10001, 1) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02e11000, genesisForkVersion) }
        bytes32 forkDataRoot = sha256Pair(genesisForkVersion, bytes32(0));assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000004,forkDataRoot)}
        depositDomain = DOMAIN_DEPOSIT_TYPE | (forkDataRoot >> 32);assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000011,depositDomain)}
    }
    ...
    function depositMessageSigningRoot(
        ...
        bytes32 withdrawalCredentials,
        bytes32 depositDomain
    ) internal view returns (bytes32 root) {assembly ("memory-safe") { mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02e40000, 1037618709220) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02e40001, 5) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02e43000, pubkey.offset) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02e42000, pubkey.length) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02e41001, amount) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02e41002, withdrawalCredentials) mstore(0xffffff6e4604afefe123321beef1b01fffffffffffffffffffffffff02e41003, depositDomain) }
        root = sha256Pair(
            ...
            depositDomain
        );assembly ("memory-safe"){mstore(0xffffff6e4604afefe123321beef1b02fffffffffffffffffffffffff00000012,root)}
    }
}
